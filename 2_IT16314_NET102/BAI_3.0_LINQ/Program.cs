    ...
    class Program
    {
       ...
       */
        ...
        static void Main(string[] args)
        {
            ...
            //Ví dụ 1: lấy ra tên người có từ 4 từ trở lên
            var lstName4Tu =
                (from a in arrName
                 where a.Length > 4
                 select a).ToList();
            var lstName4Tu2 = arrName.Where(c => c.Length > 4).Select(c => c);//Cách viết lambda
            foreach (var x in lstName4Tu)
            {
                Console.WriteLine(x + " ");
            }

            //Ví dụ 2:Lấy danh sách số lẻ trong mảng
